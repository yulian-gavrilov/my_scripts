...
Data600 = importdata ('./cpmgallpeakser/ci2_wt_600MHZ_peaks_all.ser',' ',13); % unsorted res58, res30 etc
Data750 = importdata ('./cpmgallpeakser/ci2_wt_750MHZ_peaks_all.ser',' ',13); % unsorted

Data600_max = importdata('./serfiles_max_min/WT_600MHz_peaks20.ser');% unsorted
Data750_max = importdata('./serfiles_max_min/WT_750MHz_peaks20.ser');% unsorted
...
load('./r1rho2and4kHz/R20_WT_R1r_600_4kHz');R20_600_4kHz = R20_WT_R1r_600_4kHz;% sorted!
load('./r1rho2and4kHz/R20_WT_R1r_750_4kHz');R20_750_4kHz = R20_WT_R1r_750_4kHz;% sorted!
...
vclist_sec_600 = [vclist;2000;4000];%./T;
vclist_sec_750 = [vclist;2000;4000];%./T;
...
zeros59=zeros(size(R1rhoPeaks_600_2kHz,1),1);
...
for i=1:size(R1rhoPeaks_600_2kHz,1)
